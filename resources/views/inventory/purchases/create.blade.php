<x-app-layout title="تسجيل عملية شراء">
    <h1 class="mb-6 text-xl font-semibold text-gray-900">تسجيل عملية شراء</h1>
    ...
    <form method="POST" action="{{ route('inventory.purchases.store') }}" class="max-w-md space-y-4">
        ...
        <div class="flex gap-3">
            ...
            <a href="{{ route('inventory.purchases.index') }}" class="rounded-md border border-border px-4 py-2 text-sm text-gray-700 hover:bg-gray-50">
                {{ __('Cancel') }}
            </a>
        </div>
    </form>
