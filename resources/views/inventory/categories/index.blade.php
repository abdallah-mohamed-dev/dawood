<x-app-layout title="التصنيفات">
    <div class="mb-6 flex items-center justify-between">
        ...
        <a href="{{ route('inventory.categories.create') }}" class="rounded-md bg-primary px-4 py-2 text-sm font-medium text-white hover:bg-primary-dark">
            {{ __('Add') }}
        </a>
    </div>
        ...
        <table class="min-w-full divide-y divide-border text-sm">
            <thead class="bg-gray-50">
                <tr>
                    ...
                    <th class="px-4 py-2 text-start font-medium text-secondary">عدد المواد</th>
