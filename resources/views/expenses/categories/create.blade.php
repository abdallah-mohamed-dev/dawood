<x-app-layout title="إضافة بند مصروف">
    <h1 class="mb-6 text-2xl font-bold tracking-tight text-gray-900">إضافة بند مصروف</h1>

    <form method="POST" action="{{ route('expenses.categories.store') }}" class="max-w-md space-y-4">
        @csrf
