<x-app-layout title="تعديل بند مصروف">
    <h1 class="mb-6 text-2xl font-bold tracking-tight text-gray-900">تعديل بند مصروف</h1>

    <form method="POST" action="{{ route('expenses.categories.update', $category) }}" class="max-w-md space-y-4">
        @csrf
        @method('PUT')

        @include('expenses.categories._fields')
