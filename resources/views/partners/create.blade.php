<x-app-layout title="إضافة شريك">
    <h1 class="mb-6 text-2xl font-bold tracking-tight text-gray-900">إضافة شريك</h1>

    <form method="POST" action="{{ route('partners.store') }}" class="max-w-md space-y-4">
        @csrf
        ...
        <div class="flex gap-3">
            ...
            <a href="{{ route('partners.index') }}" class="rounded-md border border-border px-4 py-2 text-sm text-gray-700 hover:bg-bg">
                {{ __('Cancel') }}
            </a>
        </div>
    </form>
